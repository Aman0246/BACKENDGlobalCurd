...
const globalCrudController = {
  create: (model) => async (req, res) => {
    try {
      ...
      return apiErrorRes(req, res, CONSTANTS_MSG.FAILED, modelData.data);
    } catch (error) {
      return apiErrorRes(req, res, error.message, error.message);
    }
  },
  ...
  update: (model) => async (req, res) => {
    try {
      ...
      return apiErrorRes(req, res, CONSTANTS_MSG.FAILED, CONSTANTS.DATA_NULL);
    } catch (error) {
      return apiErrorRes(req, res, error.message, error.message);
    }
  },
